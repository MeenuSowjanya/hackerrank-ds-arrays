...
def hourglassSum(hourglass_array)
    result_array = []
    traversing_through_the_input_array(hourglass_array, result_array).max
end

def traversing_through_the_input_array(hourglass_array, result_array)
    number_of_row_loop_in_hourgalss_array = 4
    number_of_row_loop_in_hourgalss_array.times do |count_of_each_row_of_a_hourglass_array|
...
def traversing_through_each_hourglass(count_of_each_row_of_a_hourglass_array, result_array)
    number_of_column_loops_in_each_hourglass_set = 4
    number_of_column_loops_in_each_hourglass_set.times do |count_of_each_column_of_a_hourglass_set|
