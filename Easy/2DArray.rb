...
def calculate_sum_of_hourglassSet(hourglass_array,row_count,column_count)
    sum = hourglass_array[row_count][column] + hourglass_array[row_count][column_count+1] + hourglass_array[row_count][column_count+2] + hourglass_array[row_count+1][column_count+1] + hourglass_array[row_count+2][column_count] + hourglass_array[row_count+2][column_count+1] + hourglass_array[row_count+2][column_count+2]
end
